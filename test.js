...
function testPerspective(ctx) {
    var p1 = new Vector4(0, 30, -50);
    var p2 = new Vector4(-30, -30, -50);
    var p3 = new Vector4(30, -30, -50);
    var screen = new Screen3D(1024, 768);
    var camera = new Camera(90, 5 / 4, 0.01, 1000);
    var v1 = new Vertex(p1.transform(camera.view2Clipping).clip().transform(screen.ndc2screen), new Vector4(255, 0, 0));
    var v2 = new Vertex(p2.transform(camera.view2Clipping).clip().transform(screen.ndc2screen), new Vector4(0, 255, 0));
    var v3 = new Vertex(p3.transform(camera.view2Clipping).clip().transform(screen.ndc2screen), new Vector4(0, 0, 255));
    rasterize(v1, v2, v3, ctx);
}
function testLookAt(ctx) {
    ...
    var v1 = new Vertex(p1.transform(camera.world2View).transform(camera.view2Clipping).clip().transform(screen.ndc2screen), new Vector4(255, 0, 0));
    var v2 = new Vertex(p2.transform(camera.world2View).transform(camera.view2Clipping).clip().transform(screen.ndc2screen), new Vector4(0, 255, 0));
    var v3 = new Vertex(p3.transform(camera.world2View).transform(camera.view2Clipping).clip().transform(screen.ndc2screen), new Vector4(0, 0, 255));
    rasterize(v1, v2, v3, ctx);
}
